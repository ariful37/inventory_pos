    ...
    <div>
       ...
       <div class="row card container">
          <div class="card-header">
            ...
            Customer Insert
            <router-link to="/customer-add" class="btn btn-sm btn-info" id="add_new"> Add New</router-link>
          </div>
          <div class="card-body">
            <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr v-for="customer in filtersearch" :key="customer.id">
                      ...
                      <td>
                        ...
                        <router-link :to="{name: 'customer-edit', params:{id: customer.id} }" class="btn btn-sm btn-info">Edit</router-link>
